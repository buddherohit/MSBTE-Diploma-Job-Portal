...
<footer className="md:hidden fixed bottom-0 w-full z-50 bg-surface shadow-md border-t border-outline-variant rounded-t-xl flex justify-around items-center px-2 py-2 pb-safe">
<a className="flex flex-col items-center justify-center text-on-surface-variant hover:text-primary transition-transform duration-150 scale-95" href="/student-portal/dashboard">
<span className="material-symbols-outlined" data-icon="dashboard">dashboard</span>
<span className="text-[10px] font-semibold mt-0.5">Dashboard</span>
</a>
<a className="flex flex-col items-center justify-center text-on-surface-variant hover:text-primary transition-transform duration-150 scale-95" href="/public/find-diploma-jobs">
<span className="material-symbols-outlined" data-icon="work">work</span>
<span className="text-[10px] font-semibold mt-0.5">Jobs</span>
</a>
<a className="flex flex-col items-center justify-center text-on-surface-variant hover:text-primary transition-transform duration-150 scale-95" href="Find Diploma Jobs.html?type=internship">
<span className="material-symbols-outlined" data-icon="local_activity">local_activity</span>
<span className="text-[10px] font-semibold mt-0.5">Internships</span>
</a>
<a className="flex flex-col items-center justify-center text-on-surface-variant hover:text-primary transition-transform duration-150 scale-95" href="/student-portal/resume-builder-dashboard">
<span className="material-symbols-outlined" data-icon="description">description</span>
<span className="text-[10px] font-semibold mt-0.5">Resumes</span>
</a>
<a className="flex flex-col items-center justify-center text-on-surface-variant hover:text-primary transition-transform duration-150 scale-95" href="/student-portal/profile">
