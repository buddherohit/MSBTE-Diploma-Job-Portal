...
<button className={`flex-none px-4 py-2 rounded-full font-label-md text-label-md whitespace-nowrap ${currentBranch === 'Mechanical' ? 'bg-primary-fixed text-on-primary-fixed' : 'bg-surface-container-high text-on-surface-variant border border-outline-variant hover:border-primary transition-colors'}`} onClick={() => filterBranch('Mechanical')}>ME (Mechanical)</button>
<button className={`flex-none px-4 py-2 rounded-full font-label-md text-label-md whitespace-nowrap ${currentBranch === 'Civil' ? 'bg-primary-fixed text-on-primary-fixed' : 'bg-surface-container-high text-on-surface-variant border border-outline-variant hover:border-primary transition-colors'}`} onClick={() => filterBranch('Civil')}>CE (Civil)</button>
<button className={`flex-none px-4 py-2 rounded-full font-label-md text-label-md whitespace-nowrap ${currentBranch === 'Electrical' ? 'bg-primary-fixed text-on-primary-fixed' : 'bg-surface-container-high text-on-surface-variant border border-outline-variant hover:border-primary transition-colors'}`} onClick={() => filterBranch('Electrical')}>EE (Electrical)</button>
<button className={`flex-none px-4 py-2 rounded-full font-label-md text-label-md whitespace-nowrap ${currentBranch === 'Computer' || currentBranch === 'IT' ? 'bg-primary-fixed text-on-primary-fixed' : 'bg-surface-container-high text-on-surface-variant border border-outline-variant hover:border-primary transition-colors'}`} onClick={() => filterBranch('Computer')}>IT/Comp</button>
</div>
...
{/* Job Card 1 (Mechanical) */}
{(currentBranch === 'all' || currentBranch === 'Mechanical') && (
...
{/* Job Card 2 (Civil) */}
{(currentBranch === 'all' || currentBranch === 'Civil') && (
<article className="bg-surface border border-outline-variant rounded-xl p-5 hover:shadow-[0px_4px_12px_rgba(15,23,42,0.08)] transition-all flex flex-col md:flex-row md:items-center gap-4 group">
<div className="flex-none w-16 h-16 rounded-lg bg-surface-container flex items-center justify-center p-2 border border-outline-variant">
...
{/* Job Card 3 (Computer/IT) */}
{(currentBranch === 'all' || currentBranch === 'Computer' || currentBranch === 'IT') && (
<article className="bg-surface border border-outline-variant rounded-xl p-5 hover:shadow-[0px_4px_12px_rgba(15,23,42,0.08)] transition-all flex flex-col md:flex-row md:items-center gap-4 group">
<div className="flex-none w-16 h-16 rounded-lg bg-surface-container flex items-center justify-center p-2 border border-outline-variant">
