            ...
            <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-8 shadow-sm">
                ...
                <div className="hidden space-y-6 text-center py-2" id="success-state">
                    ...
                    <div className="flex justify-between items-center text-sm pt-2">
                        ...
                        <a className="text-primary font-bold hover:underline" href="/public/student-login">
                            Back to Login
                        </a>
                    </div>
                </div>
                ...
                <div className="hidden space-y-6 text-center py-4" id="success-reset-state">
                    ...
                    <a className="w-full bg-primary text-white py-3 rounded-lg font-bold hover:brightness-110 transition-all block" href="/public/student-login">
                        Go to Login
                    </a>
                </div>
            </div>
