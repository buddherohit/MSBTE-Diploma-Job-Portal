...
<a href="/public/find-diploma-jobs" className="hidden md:flex items-center gap-2 px-4 py-2 text-on-surface-variant hover:bg-surface-container transition-colors duration-200 rounded-lg">
                Jobs
            </a>
...
<span id="appliedCountStat" className="text-display-lg font-display-lg text-primary">12</span>
...
<a href="/student-portal/saved-jobs-student-portal" className="bg-white border border-outline-variant rounded-xl p-5 flex flex-col justify-center items-center text-center hover:shadow-md transition-shadow hover:scale-[1.02] transition-transform">
<span id="savedCountStat" className="text-display-lg font-display-lg text-primary">5</span>
...
{/* Home/Dashboard */}
<a className="flex flex-col items-center justify-center text-primary dark:text-primary-fixed bg-primary-fixed dark:bg-on-primary-fixed-variant rounded-xl px-3 py-1 transition-all duration-200" href="/student-portal/dashboard">
...
<button onclick="window.location.href='../public/Find Diploma Jobs.html'" className="fixed bottom-20 right-4 md:bottom-8 md:right-8 w-14 h-14 bg-secondary-container text-on-secondary-container rounded-full shadow-lg flex items-center justify-center hover:scale-105 transition-transform z-40">
