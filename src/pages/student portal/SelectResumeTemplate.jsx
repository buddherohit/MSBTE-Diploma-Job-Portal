...
<span className="material-symbols-outlined text-primary dark:text-inverse-primary" data-icon="school">school</span>
<h1 className="font-headline-md text-headline-md font-bold text-primary dark:text-inverse-primary">MahaResume</h1>
</div>
