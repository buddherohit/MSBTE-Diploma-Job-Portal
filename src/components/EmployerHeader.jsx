            ...
            <div className="relative flex items-center gap-4 z-50">
              ...
              {dropdownOpen && (
                <>
                  ...
                  <div className="absolute right-0 top-12 z-50 w-64 bg-white border border-outline-variant shadow-xl rounded-2xl p-4 flex flex-col gap-3 animate-in fade-in slide-in-from-top-2 duration-200">
